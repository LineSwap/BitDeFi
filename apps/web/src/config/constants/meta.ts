...
export const DEFAULT_META: PageMeta = {
  title: 'BitDeFi',
  description:
    'The first DEFI AMM built on Mantle Network.',
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for BitDeFi exchanges.' },
      '/info/pairs': { title: t('Pairs'), description: 'View statistics for BitDeFi exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for BitDeFi exchanges.' },
